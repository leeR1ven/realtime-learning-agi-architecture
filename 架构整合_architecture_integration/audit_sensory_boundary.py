...
sys.path.insert(0, str(ROOT/'色标导航_color_beacon_navigation'))
...
def main():
    ...
    report = {'distance_encoding': {
        'source': '色标导航_color_beacon_navigation/associative_controller.py:104,181,213',
    ...
    report['directional_touch'] = {
        'source': '闭环仿真_closed_loop_sim/world.py:230; 色标导航_color_beacon_navigation/associative_controller.py:178',
    ...
    for filename in ('route_switch_evaluation.npz', 'route_texture_evaluation.npz'):
        path = ROOT/'色标导航_color_beacon_navigation'/'results'/filename
    ...
    report['velocity_angular_clipping'] = {
        'source': '色标导航_color_beacon_navigation/associative_controller.py:182',
    ...
    report['restricted_audio'] = {
        'source': '色标导航_color_beacon_navigation/route_switch_controller.py:28,41',
    ...
    report['action_consequence_timing'] = {
        'sources': ['色标导航_color_beacon_navigation/associative_controller.py:492', '色标导航_color_beacon_navigation/route_switch_experiment.py:73',
                    '色标导航_color_beacon_navigation/route_switch_experiment.py:77', '色标导航_color_beacon_navigation/route_switch_experiment.py:88'],
